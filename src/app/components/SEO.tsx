...
const SEO: React.FC<SEOProps> = ({
  ...
  const enhancedKeywords = pathname.includes('smart-ppe-revolution') 
    ...
    : pathname.includes('wearable-safety-tech-protecting-workers-roi')
    ? [
        ...keywords,
  ...
  const smartPPEFAQData = pathname.includes('smart-ppe-revolution') ? {
    '@context': 'https://schema.org',
    '@type': 'FAQPage',
    mainEntity: [
      {
  ...
  const wearableSafetyROIFAQData = pathname.includes('wearable-safety-tech-protecting-workers-roi') ? {
    '@context': 'https://schema.org',
    '@type': 'FAQPage',
    mainEntity: [
      {
