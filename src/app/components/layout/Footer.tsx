...
import { toast } from "../../hooks/use-toast"; // Or use `sonner` if not using custom hook
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 pb-10 border-b border-gray-700">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6">
              WRLDS Technologies provides an end-to-end platform for AI-powered smart sensor devices, giving customers 100% ownership while handling the full tech stack.
            </p>
            <p className="text-gray-300 mb-6">
              Hornsgatan 110<br />
