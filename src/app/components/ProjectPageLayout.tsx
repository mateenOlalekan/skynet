...
interface ProjectPageLayoutProps {
  ...
  subtitle: string;
  imageUrl: string;
  brandName?: string; // Made optional since not used in component
  darkMode?: boolean;
}
...
const ProjectPageLayout: React.FC<ProjectPageLayoutProps> = ({
  ...
  return (
    <PageLayout>
      <div className={`pt-16 pb-16 ${bgColor}`}> {/* Added bgColor */}
        {/* Hero Section */}
        <div 
        ...
        <div className="w-full max-w-4xl mx-auto px-6 md:px-8 mt-8">
          <Link href="/projects" className="inline-flex items-center text-gray-600 hover:text-gray-800 transition-colors"> {/* Changed 'to' to 'href' */}
